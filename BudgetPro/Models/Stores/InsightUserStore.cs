...
namespace BudgetPro.Models.Stores
{
        ...
        IUserTwoFactorStore<ApplicationUser, int>
    {
        ...
        {
            return _userData.FindUserByLoginAsync(login.ProviderKey, login.LoginProvider);
        }
        ...
        {
            // get the claims from the database table
        ...
        {
            return Task.FromResult(_userData.RemoveUserClaimAsync(user.Id, claim.Type));
        }
